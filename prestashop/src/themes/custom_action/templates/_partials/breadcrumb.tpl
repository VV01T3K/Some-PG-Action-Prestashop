 ...
 *}
<div class="relative flex w-full flex-col px-4 lg:px-8" data-testid="breadcrumbs-container">
  <div class="mx-auto w-full max-w-7xl">
    <div class="py-4">
      <nav class="no-scrollbar -mr-4 flex items-center gap-0.5 overflow-y-auto py-0.5" 
        ...
        {block name='breadcrumb'}
          ...
          {if $breadcrumb.count > 1}
            <div class="flex items-center">
              <button onclick="window.history.back()" class="group text-body-small flex items-center" data-testid="breadcrumb-back-button">
            ...
            {if $smarty.foreach.breadcrumb.index > 0}
              {block name='breadcrumb_item'}
                {if not $smarty.foreach.breadcrumb.last}
                  <a class="group flex items-center text-body-small whitespace-nowrap" 
                     href="{$path.url}" 
