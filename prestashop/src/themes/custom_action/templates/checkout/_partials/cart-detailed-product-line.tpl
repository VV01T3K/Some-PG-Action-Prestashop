 ...
 *}
<div data-testid="product-row" data-content-king="product-row" style="display: flex; justify-content: space-between; gap: 1rem; padding: 1rem 0; align-items: flex-start;">
  
  {* CHECKBOX / FAVORITE BUTTON *}
  <div style="display: flex; flex-shrink: 0; padding-top: 0.25rem;">
  ...
  {* MAIN CONTENT *}
  <div style="display: flex; width: 100%; gap: 1rem; flex: 1;">
    ...
    <div style="display: flex; width: 100%; justify-content: space-between; align-items: flex-start; gap: 1rem;">
