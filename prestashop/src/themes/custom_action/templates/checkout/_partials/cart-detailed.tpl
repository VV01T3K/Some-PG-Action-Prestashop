...
{block name='cart_detailed_product'}
  <div
    ...
    data-empty-label="{l s='There are no more items in your cart' d='Shop.Theme.Checkout'}"
  >
    {if $cart.products}
    <ul class="cart-items">
    ...
    <span class="no-items" style="display:none;">{l s='There are no more items in your cart' d='Shop.Theme.Checkout'}</span>
    {else}
