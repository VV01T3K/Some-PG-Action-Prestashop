            ...
            <div class="PageTeaser_container___lPp9" data-testid="page-teaser">
              <div class="relative flex flex-col md:flex-row-reverse PageTeaser_innerContainer__HRU_X">
                <div class="PageTeaser_imageWrapper__coJ1u">
                  <picture>
                    <source
                      srcset="/static/images/t_digital_page_teaser_mobile_w_128_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp 128w, /static/images/t_digital_page_teaser_mobile_w_256_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp 256w, /static/images/t_digital_page_teaser_mobile_w_640_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp 640w, /static/images/t_digital_page_teaser_mobile_w_1080_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp 1080w, /static/images/t_digital_page_teaser_mobile_w_1920_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp 1920w"
                    ...
                    <source
                      ...
                      sizes="100vw"
                      srcset="/static/images/t_digital_page_teaser_mobile_w_128_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp 128w, /static/images/t_digital_page_teaser_mobile_w_256_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp 256w, /static/images/t_digital_page_teaser_mobile_w_640_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp 640w, /static/images/t_digital_page_teaser_mobile_w_1080_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp 1080w, /static/images/t_digital_page_teaser_mobile_w_1920_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp 1920w"
                      src="/static/images/t_digital_page_teaser_mobile_w_1920_Contentpage_Decoration_InteriorDecoration_CreateWallStorage_2021_dbh0eq.webp">
                  </picture>
                </div>
...
href="/10-Hobby" aria-label="Hobby" data-testid="content-card">
                  <div class="relative h-full w-full overflow-hidden rounded-md"><img data-testid="content-card-image"
                      ...
                      srcset="/static/images/t_digital_content_card_small_w_128_VanBleiswijck_StationeryAndHobby_HobbyPainting_HobbyPaint_Brushes_2023_efvs6y.webp 128w, /static/images/t_digital_content_card_small_w_256_VanBleiswijck_StationeryAndHobby_HobbyPainting_HobbyPaint_Brushes_2023_efvs6y.webp 256w, /static/images/t_digital_content_card_small_w_640_VanBleiswijck_StationeryAndHobby_HobbyPainting_HobbyPaint_Brushes_2023_efvs6y.webp 640w, /static/images/t_digital_content_card_small_w_1080_VanBleiswijck_StationeryAndHobby_HobbyPainting_HobbyPaint_Brushes_2023_efvs6y.webp 1080w, /static/images/t_digital_content_card_small_w_1920_VanBleiswijck_StationeryAndHobby_HobbyPainting_HobbyPaint_Brushes_2023_efvs6y.webp 1920w"
                      src="/static/images/t_digital_content_card_small_w_1920_VanBleiswijck_StationeryAndHobby_HobbyPainting_HobbyPaint_Brushes_2023_efvs6y.webp">
                  </div>
...
href="/14-zrob-to-sam" aria-label="DIY" data-testid="content-card">
                  <div class="relative h-full w-full overflow-hidden rounded-md"><img data-testid="content-card-image"
                      ...
                      style="position:absolute;height:100%;width:100%;left:0;top:0;right:0;bottom:0;color:transparent"
                      sizes="(min-width: 1280px) calc(1280px / 4), (min-width: 1024px) calc(100vw / 4), (min-width: 768px) calc(100vw / 4), (min-width: 640px) calc(100vw / 3), calc(100vw / 2)"
                      srcset="/static/images/t_digital_content_card_small_w_128_AX-Power_DIY_ToolsAndIronware_PowertoolsBattery_CordlessDrillInUseWall_2020_kzheor.webp 128w, /static/images/t_digital_content_card_small_w_256_AX-Power_DIY_ToolsAndIronware_PowertoolsBattery_CordlessDrillInUseWall_2020_kzheor.webp 256w, /static/images/t_digital_content_card_small_w_640_AX-Power_DIY_ToolsAndIronware_PowertoolsBattery_CordlessDrillInUseWall_2020_kzheor.webp 640w, /static/images/t_digital_content_card_small_w_1080_AX-Power_DIY_ToolsAndIronware_PowertoolsBattery_CordlessDrillInUseWall_2020_kzheor.webp 1080w, /static/images/t_digital_content_card_small_w_1920_AX-Power_DIY_ToolsAndIronware_PowertoolsBattery_CordlessDrillInUseWall_2020_kzheor.webp 1920w"
                      src="/static/images/t_digital_content_card_small_w_1920_AX-Power_DIY_ToolsAndIronware_PowertoolsBattery_CordlessDrillInUseWall_2020_kzheor.webp">
                  </div>
                  <div class="flex items-center">
                    <h3
                      class="text-dark-blue-500 line-clamp-2 flex min-w-0 items-center text-sm font-bold first-letter:uppercase sm:text-base"
