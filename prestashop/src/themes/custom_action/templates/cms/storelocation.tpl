...
{block name='page_content_container'}
  <main id="layout-page-content" class="relative flex flex-1 flex-col">
    ...
    <div class="flex flex-1 flex-col" data-testid="cms-content-rows">
      ...
      <section class="bg-neutral-0 lg:pb-8 lg:pt-0" aria-label="Rozwijaj się z nami Poszukiwany lokal handlowy"
            ...
            <div class="PageTeaser_container___lPp9" data-testid="page-teaser">
              <div class="relative flex flex-col md:flex-row-reverse PageTeaser_innerContainer__HRU_X">
                <div class="PageTeaser_imageWrapper__coJ1u">
                  <picture>
                    <source
                      srcset="https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_128/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp 128w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_256/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp 256w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_640/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp 640w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_1080/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp 1080w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_1920/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp 1920w"
                    ...
                    <source
                      ...
                      sizes="100vw"
                      srcset="https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_128/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp 128w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_256/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp 256w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_640/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp 640w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_1080/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp 1080w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_1920/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp 1920w"
                      src="https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_1920/ActionStore_RealEstate_Location_Pageteaser_2022_o4xoeq.webp">
                  </picture>
                </div>
                <div data-testid="page-teaser-content"
                  class="relative flex flex-col gap-4 md:absolute md:left-0 md:w-full md:gap-6 PageTeaser_contentSection___15Hr px-4 pt-4 md:p-8"
                        ...
                        class="ml-[13px] md:ml-[17px] max-w-[calc(100%-28px)] md:max-w-[calc(100%-35px)]"><span
                          class="relative z-3 flex flex-row"><span
                            class="flex origin-bottom skew-x-[-18deg] items-center overflow-hidden rounded-tl-[4px] rounded-tr-[2px] rounded-br-[4px] rounded-bl-[2px] bg-dark-blue-500 px-[22px] py-2 md:px-6"><span
                              ...
                              data-testid="trapezium-title">Rozwijaj się z nami</span></span></span></span><span
                        class="hidden">&nbsp;</span><span
                        class="max-w-[calc(100%-11px)] md:max-w-[calc(100%-14px)]"><span
                          class="relative z-3 flex flex-row"><span
                            class="flex origin-bottom skew-x-[-18deg] items-center overflow-hidden rounded-tl-[4px] rounded-tr-[2px] rounded-br-[4px] rounded-bl-[2px] bg-cyan px-4 py-[6px] md:px-5"><span
                              ...
                              data-testid="trapezium-subtitle">Poszukiwany lokal handlowy</span></span></span></span>
                    </h1>
                  </div>
                </div>
              </div>
      ...
      <section class="bg-neutral-50 pt-6 md:pt-8 pb-6 md:pb-8" aria-label="Dyskontem niespożywczym"
        ...
        <div class="relative flex w-full flex-col px-4 lg:px-8">
          <div class="mx-auto w-full max-w-7xl">
            <div class="flex flex-col gap-4" data-content-king="rich-text">
              ...
              <div class="max-w-2xl"><iframe data-testid="youtube-player" class="border-none aspect-video w-full"
                  src="https://www.youtube.com/embed/snsNPxmqJ5s" allowfullscreen="" title="Embedded youtube"></iframe>
              </div>
            </div>
          </div>
        </div>
      </section>
      <section class="bg-neutral-0 pt-6 md:pt-8 pb-6 md:pb-8" aria-label="Nasza unikalna formuła"
        data-testid="cms-markdown">
        <div class="relative flex w-full flex-col px-4 lg:px-8">
          <div class="mx-auto w-full max-w-7xl">
            <div class="flex flex-col gap-4" data-content-king="rich-text">
              ...
              <div class="flex max-w-[800px] flex-col gap-3">
                ...
                <p class="text-body-normal text-neutral-900" data-testid="markdown-paragraph"><a
                    ...
                    href="mailto:nieruchomosc@action.eu" target="_blank" data-testid="markdown-link"
                    rel="noreferrer noopener">Propozycja lokalizacji</a></p>
              </div>
              <div class="w-full max-w-2xl"><img alt="ActionStore_RealEstate_Location_Splitteaser_2022" loading="lazy"
                  width="672" height="400" decoding="async" data-nimg="1" class="" style="color:transparent"
                  srcset="https://asset.action.com/image/upload/w_1080/ActionStore_RealEstate_Location_Splitteaser_2022_sncyli.webp 1x, https://asset.action.com/image/upload/w_1920/ActionStore_RealEstate_Location_Splitteaser_2022_sncyli.webp 2x"
                  src="https://asset.action.com/image/upload/w_1920/ActionStore_RealEstate_Location_Splitteaser_2022_sncyli.webp">
              </div>
            </div>
          </div>
        </div>
      </section>
      <section class="bg-neutral-50 pt-6 md:pt-8 pb-6 md:pb-8" aria-label="Nasza idealna lokalizacja sklepu"
        data-testid="cms-markdown">
        <div class="relative flex w-full flex-col px-4 lg:px-8">
          <div class="mx-auto w-full max-w-7xl">
            <div class="flex flex-col gap-4" data-content-king="rich-text">
              ...
              <div class="flex max-w-[800px] flex-col gap-3">
                <p class="text-body-normal text-neutral-900" data-testid="markdown-paragraph">Chcemy być jak najbliżej
                  ...
                  przestrzeni sklepowej naszemu zespołowi ds⁠. nieruchomości na adres&nbsp;<a
                    class="text-dark-blue-500 hover:shadow-bottom-border w-fit break-words"
                    href="mailto:nieruchomosc@action.eu" target="_blank" data-testid="markdown-link"
                    rel="noreferrer noopener">nieruchomosc@action⁠.eu</a>⁠.</p>
              </div>
              <div class="w-full max-w-2xl"><img alt="infographic_ActionStore_RealEstate_AC_2025_PL" loading="lazy"
                  width="672" height="400" decoding="async" data-nimg="1" class="" style="color:transparent"
                  srcset="https://asset.action.com/image/upload/w_1080/infographic_ActionStore_RealEstate_AC_2025_PL_hs4syy.webp 1x, https://asset.action.com/image/upload/w_1920/infographic_ActionStore_RealEstate_AC_2025_PL_hs4syy.webp 2x"
                  src="https://asset.action.com/image/upload/w_1920/infographic_ActionStore_RealEstate_AC_2025_PL_hs4syy.webp">
              </div>
            </div>
          </div>
        </div>
      </section>
      <section class="bg-neutral-0 pt-6 md:pt-8 pb-6 md:pb-8" aria-label="Zrównoważony rozwój w Action"
        data-testid="cms-markdown">
        <div class="relative flex w-full flex-col px-4 lg:px-8">
          <div class="mx-auto w-full max-w-7xl">
            <div class="flex flex-col gap-4" data-content-king="rich-text">
              ...
              <div class="flex max-w-[800px] flex-col gap-3">
                ...
                <p class="text-body-normal text-neutral-900" data-testid="markdown-paragraph"><a
                    class="text-dark-blue-500 hover:shadow-bottom-border w-fit break-words"
                    href="https://company.action.com/sustainability-new/" target="_blank" data-testid="markdown-link"
                    rel="noreferrer noopener">Więcej o zrównoważony rozwoju</a></p>
              </div>
              <div class="w-full max-w-2xl"><img alt="ActionStore_Shop_Shelves_Products_Towels_2022" loading="lazy"
                  width="672" height="400" decoding="async" data-nimg="1" class="" style="color:transparent"
                  srcset="https://asset.action.com/image/upload/w_1080/ActionStore_Shop_Shelves_Products_Towels_2022_ol7kss.webp 1x, https://asset.action.com/image/upload/w_1920/ActionStore_Shop_Shelves_Products_Towels_2022_ol7kss.webp 2x"
                  src="https://asset.action.com/image/upload/w_1920/ActionStore_Shop_Shelves_Products_Towels_2022_ol7kss.webp">
              </div>
            </div>
          </div>
        </div>
