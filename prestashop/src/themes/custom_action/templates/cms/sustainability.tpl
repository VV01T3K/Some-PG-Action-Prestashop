...
{block name='page_content_container'}
  <main id="layout-page-content" class="relative flex flex-1 flex-col">
    ...
    <div class="flex flex-1 flex-col" data-testid="cms-content-rows">
      ...
      <section class="bg-neutral-0 lg:pb-8 lg:pt-0" aria-label="Dobra jakość w najniższej cenie!"
            ...
            <div class="PageTeaser_container___lPp9" data-testid="page-teaser">
              <div class="relative flex flex-col md:flex-row-reverse PageTeaser_innerContainer__HRU_X">
                <div class="PageTeaser_imageWrapper__coJ1u">
                  <picture>
                    <source
                      srcset="https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_128/Sustainability_Toys_Woodentoys_2025_soi9x0.webp 128w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_256/Sustainability_Toys_Woodentoys_2025_soi9x0.webp 256w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_640/Sustainability_Toys_Woodentoys_2025_soi9x0.webp 640w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_1080/Sustainability_Toys_Woodentoys_2025_soi9x0.webp 1080w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_1920/Sustainability_Toys_Woodentoys_2025_soi9x0.webp 1920w"
                    ...
                    <source
                      ...
                      sizes="100vw"
                      srcset="https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_128/Sustainability_Toys_Woodentoys_2025_soi9x0.webp 128w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_256/Sustainability_Toys_Woodentoys_2025_soi9x0.webp 256w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_640/Sustainability_Toys_Woodentoys_2025_soi9x0.webp 640w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_1080/Sustainability_Toys_Woodentoys_2025_soi9x0.webp 1080w, https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_1920/Sustainability_Toys_Woodentoys_2025_soi9x0.webp 1920w"
                      src="https://asset.action.com/image/upload/t_digital_page_teaser_mobile/w_1920/Sustainability_Toys_Woodentoys_2025_soi9x0.webp">
                  </picture>
                </div>
                        ...
                        class="ml-[17px] md:ml-5 max-w-[calc(100%-32px)] md:max-w-[calc(100%-38px)]"><span
                          class="relative z-3 flex flex-row"><span
                            class="flex origin-bottom skew-x-[-18deg] items-center overflow-hidden rounded-tl-[4px] rounded-tr-[2px] rounded-br-[4px] rounded-bl-[2px] bg-dark-blue-500 px-[22px] py-2 md:px-6"><span
                              ...
                              data-testid="trapezium-title">Dobra jakość</span></span></span></span><span
                        class="hidden">&nbsp;</span><span class="max-w-[calc(100%-15px)] md:max-w-[calc(100%-18px)]"><span
                          class="relative z-3 flex flex-row"><span
                            class="flex origin-bottom skew-x-[-18deg] items-center overflow-hidden rounded-tl-[4px] rounded-tr-[2px] rounded-br-[4px] rounded-bl-[2px] bg-dark-blue-500 px-[22px] py-2 md:px-6"><span
                              class="text-neutral-0 z-1 line-clamp-1 skew-x-18 break-words heading-2xl"
                              data-testid="trapezium-subtitle">w najniższej cenie!</span></span></span></span></h1>
                  </div>
          ...
          <div class="mx-auto w-full max-w-7xl">
            <div class="flex flex-col gap-4" data-content-king="rich-text">
              <div class="max-w-2xl"><iframe data-testid="youtube-player" class="border-none aspect-video w-full"
                  src="https://www.youtube.com/embed/hpY1lVKGhno" allowfullscreen="" title="Embedded youtube"></iframe>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="bg-neutral-0 pt-6 md:pt-8 pb-6 md:pb-8" data-testid="cms-markdown">
        <div class="relative flex w-full flex-col px-4 lg:px-8">
          <div class="mx-auto w-full max-w-7xl">
            <div class="flex flex-col gap-4" data-content-king="rich-text">
              <div class="max-w-2xl"><iframe data-testid="youtube-player" class="border-none aspect-video w-full"
                  src="https://www.youtube.com/embed/OpF9FkVpKAA" allowfullscreen="" title="Embedded youtube"></iframe>
              </div>
            </div>
          </div>
        </div>
            ...
            <ul data-testid="unique-selling-points" class="grid grid-cols-1 gap-10 lg:grid-cols-2">
              <li class="col-span-1" data-testid="selling-point">
                <div class="flex gap-4">
                  <div><img data-testid="image" alt="" loading="lazy" width="80" height="80" decoding="async"
                      ...
                      srcset="https://asset.action.com/image/upload/t_digital_square/w_128/Sustainability_HUB_Linen_BathLinen_Towel_HotelRoyal_2024_cc5tv0.webp 1x, https://asset.action.com/image/upload/t_digital_square/w_256/Sustainability_HUB_Linen_BathLinen_Towel_HotelRoyal_2024_cc5tv0.webp 2x"
                      src="https://asset.action.com/image/upload/t_digital_square/w_256/Sustainability_HUB_Linen_BathLinen_Towel_HotelRoyal_2024_cc5tv0.webp">
                  </div>
                  <div class="flex flex-1 auto-rows-min flex-col gap-1 overflow-hidden">
                    <h2 class="heading-lg" data-testid="title">Bawełna</h2>
                    <p class="text-body-normal break-words whitespace-break-spaces text-neutral-900"
                      data-testid="description">Nasza bawełna pozyskiwana jest z odpowiedzialnych upraw
                    </p>
                  </div>
                </div>
              </li>
              <li class="col-span-1" data-testid="selling-point">
                <div class="flex gap-4">
                  <div><img data-testid="image" alt="" loading="lazy" width="80" height="80" decoding="async"
                      data-nimg="1" class="" style="color:transparent"
                      srcset="https://asset.action.com/image/upload/t_digital_square/w_128/Sustainability_HUB_Toys_Entertainment_Toys_ToysUnisex_MiniMatters_Package_2024_bhvahq.webp 1x, https://asset.action.com/image/upload/t_digital_square/w_256/Sustainability_HUB_Toys_Entertainment_Toys_ToysUnisex_MiniMatters_Package_2024_bhvahq.webp 2x"
                      src="https://asset.action.com/image/upload/t_digital_square/w_256/Sustainability_HUB_Toys_Entertainment_Toys_ToysUnisex_MiniMatters_Package_2024_bhvahq.webp">
                  </div>
                  <div class="flex flex-1 auto-rows-min flex-col gap-1 overflow-hidden">
                    <h2 class="heading-lg" data-testid="title">Drewno i papier</h2>
                    <p class="text-body-normal break-words whitespace-break-spaces text-neutral-900"
                      data-testid="description">Wszystkie nasze papierowe i drewniane produkty pozyskujemy w sposób
              ...
              <li class="col-span-1" data-testid="selling-point">
                <div class="flex gap-4">
                  <div><img data-testid="image" alt="" loading="lazy" width="80" height="80" decoding="async"
                      data-nimg="1" class="" style="color:transparent"
                      srcset="https://asset.action.com/image/upload/t_digital_square/w_128/Sustainability_HUB_Food_Drink_Snacks_Nuts_Snacks_ChocoMoment_2024_laifsn.webp 1x, https://asset.action.com/image/upload/t_digital_square/w_256/Sustainability_HUB_Food_Drink_Snacks_Nuts_Snacks_ChocoMoment_2024_laifsn.webp 2x"
                      src="https://asset.action.com/image/upload/t_digital_square/w_256/Sustainability_HUB_Food_Drink_Snacks_Nuts_Snacks_ChocoMoment_2024_laifsn.webp">
                  </div>
                  <div class="flex flex-1 auto-rows-min flex-col gap-1 overflow-hidden">
                    <h2 class="heading-lg" data-testid="title">Czekolada</h2>
                    <p class="text-body-normal break-words whitespace-break-spaces text-neutral-900"
                      data-testid="description">Wszystkie nasze czekolady marki własnej mają certyfikat Fairtrade</p>
                  </div>
                </div>
              </li>
            </ul>
      ...
      <section class="bg-neutral-50 pt-6 md:pt-8 pb-6 md:pb-8" aria-label="Toaletowy Pure Soft "
        ...
        <div class="relative flex w-full flex-col px-4 lg:px-8">
          <div class="mx-auto w-full max-w-7xl">
            <div class="flex flex-col gap-4" data-content-king="rich-text">
              ...
              <div class="max-w-2xl"><iframe data-testid="youtube-player" class="border-none aspect-video w-full"
                  src="https://www.youtube.com/embed/NGp6G9-iA1o" allowfullscreen="" title="Embedded youtube"></iframe>
              </div>
            </div>
          </div>
        </div>
              ...
              <li class="col-span-1" data-testid="selling-point">
                <div class="flex gap-4">
                  ...
                  <div class="flex flex-1 auto-rows-min flex-col gap-1 overflow-hidden">
                    ...
                    <p class="text-body-normal break-words whitespace-break-spaces text-neutral-900"
                      data-testid="description">We source all our cotton products responsibly.</p>
                  </div>
                </div>
              </li>
              <li class="col-span-1" data-testid="selling-point">
                <div class="flex gap-4">
                  ...
                  <div class="flex flex-1 auto-rows-min flex-col gap-1 overflow-hidden">
                    ...
                    <p class="text-body-normal break-words whitespace-break-spaces text-neutral-900"
                      data-testid="description">We source 94% of our paper and wood products more sustainably.</p>
                  </div>
                </div>
              </li>
              <li class="col-span-1" data-testid="selling-point">
                <div class="flex gap-4">
                  ...
                  <div class="flex flex-1 auto-rows-min flex-col gap-1 overflow-hidden">
                    ...
                    <p class="text-body-normal break-words whitespace-break-spaces text-neutral-900"
                      data-testid="description">All our private label chocolate is Fairtrade certified.</p>
                  </div>
                </div>
              </li>
            </ul>
